...
punts_favor INT DEFAULT 0,

punts_contra INT DEFAULT 0 );


delimiter //
create trigger classificacio_automatic after insert on partit for each row
begin
	if((select count(*) from classificacio where equip = new.equip_local)= 0 ) then
     insert into classificacio values (new.equip_local,(select count(*) from partit where punts_local > punts_visitant and equip_local = new.equip_local),
									  (select count(*) from partit where punts_local = punts_visitant and equip_local = new.equip_local),
                                      (select count(*) from partit where punts_local < punts_visitant and equip_local = new.equip_local),
                                      (select sum(punts_local) from partit where equip_local = new.equip_local),
									  (select sum(punts_visitant) from partit where equip_local = new.equip_local));
...
*/
INSERT INTO partit VALUES (1,'Girona BC','Basquet Olot','12:00',69,70);#basquet olot win
INSERT INTO partit VALUES (1,'Anglès Club','Gironès BC','11:30',82,55);#Angles Club win
INSERT INTO partit VALUES (2,'Anglès Club','Girona BC','11:30',99,75);#Anglès Club win
INSERT INTO partit VALUES (2,'Basquet Olot','Gironès BC','17:00',87,76);#Basquet Olot win
INSERT INTO partit VALUES (3,'Girona BC','Anglès Club','12:00',66,70);#Anglès Club win
INSERT INTO partit VALUES (3,'Gironès BC','Basquet Olot','10:00',80,83);#Basquet Olot win
insert INTO partit VALUES (3,'Anglès Club','Basquet Olot','12:00',80,70);#Anglès Club win
/*
